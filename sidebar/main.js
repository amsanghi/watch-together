...
import { sendChat, buildEmoji, searchGifs, searchGifsDebounced, addSys } from "./features/chat.js";
import { sendKissCam, sendBreathe } from "./features/intimacy.js";
import { getMyBpm } from "./features/heartbeat.js";
...
import { rhythmClick, startKaraoke } from "./features/beatgames.js";
import {
...
function init() {
  ...
  $("btn-rhythm").addEventListener("click", rhythmClick);
  $("btn-karaoke").addEventListener("click", startKaraoke);
